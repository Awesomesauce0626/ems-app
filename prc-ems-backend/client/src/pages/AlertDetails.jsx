...
const AlertDetails = () => {
  ...
  const handleStatusUpdate = async (e) => {
    ...
    try {
      ...
      setNote(''); // Clear note field after submission
    } catch (err) {
      setError(err.message);
    } finally {
    ...
    <div className="alert-details-container">
      ...
      <div className="details-content-grid">
        <div className="details-info-panel">
          ...
          <p><strong>Patient Age:</strong> {alert.age}</p>
          <p><strong>Medical History:</strong> {alert.medicalConditions}</p>
          <hr />
        ...
        <div className="details-action-panel">
          <div className="details-map-container">
             <MapContainer center={[alert.location.lat, alert.location.lng]} zoom={15} style={{ height: '300px', width: '100%' }}>
