...
const AlertForm = ({ onSubmit, isSubmitting }) => {
  const { register, handleSubmit, formState: { errors } } = useForm({
    ...
    defaultValues: {
        patientCount: 1,
        incidentType: incidentTypes[0].value, // Default to the first option
    }
  });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="alert-form">
      ...
      <div className="form-group">
       ...
       <div className="form-group">
        <label htmlFor="age">Patient's Estimated Age</label>
      ...
      <div className="form-group">
        ...
        {errors.medicalConditions && <p className="error-message">{errors.medicalConditions.message}</p>}
      </div>
